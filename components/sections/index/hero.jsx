			...
			<Container spacing={'VerticalXXXL'}>
				...
				<section>
					<p className={`${hero.primaryBright} subtitle ${space(["verticalLrg"])}`}>
						Motivated and dedicated Software Developer with a strong passion for generative AI, Large Language Models, and AI ecosystem.
					</p>					
				</section>
				<section>
					<button	className={`button ${button.primary}`}
							onClick={ () => window.location = 'mailto:satitek5@gmail.com' } >
						Contact Me
					</button>
					<button className={`button ${button.secondary} leaveSite`}
							onClick={ ()=> window.open("https://www.linkedin.com/in/tek-dakwak-b78641235", "_blank") } >
						LinkedIn
					</button>
				</section>
			</Container>
